...
namespace evolent.webapi.Tests.Controllers
{
    ...
    public class TestContactController
    {
        ...
        public void Get_ShouldReturnAllContacts()
        {
            ...
            var controllerResult = new ContactController().Get() as OkNegotiatedContentResult<IEnumerable<ContactModel>>;
        ...
        public void GetContact_ShouldReturnContact()
        {
            ...
            var controllerResult = new ContactController().Get(1) as OkNegotiatedContentResult<ContactModel>;
            Assert.IsNotNull(controllerResult);
